...
This particular dataset contains 13 variables and just under 1,600 observations
...
qplot(x = volatile.acidity, data = wqr)

qplot(x = citric.acid, data = wqr)

qplot(x = residual.sugar, data = wqr, binwidth=0.5)

qplot(x = chlorides, data = wqr, binwidth=0.01)

qplot(x = free.sulfur.dioxide, data = wqr, binwidth=2)

qplot(x = total.sulfur.dioxide, data = wqr, binwidth=0.1) + 
  scale_x_log10()

qplot(x = density, data = wqr)

qplot(x = pH, data = wqr, binwidth=0.05)

qplot(x = sulphates, data = wqr)

qplot(x = alcohol, data = wqr, binwidth=0.05)
```
